...
cat circuit/Device-Template/fp-info-cache 		| sed 's/Device-Template/'$device_name'/' > 'circuit/Device-Template/fp-info-cache'
cat circuit/Device-Template/fp-lib-table 		| sed 's/Device-Template/'$device_name'/' > 'circuit/Device-Template/fp-lib-table'
cat circuit/Device-Template/sym-lib-table 		| sed 's/Device-Template/'$device_name'/' > 'circuit/Device-Template/sym-lib-table'
